...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#queryBtn").click(function () {
			queryActivityForPageByCondition(1,$("#demo_page").bs_pagination("getOption","rowsPerPage"))
		})
			...
			$.ajax({
				...
				success:function (data) {
					if(data.code=="1"){
						...
						queryActivityForPageByCondition($("#demo_page").bs_pagination("getOption","currentPage"),$("#demo_page").bs_pagination("getOption","rowsPerPage"))
					}else {
						alert(data.message);
						$("#editActivityModal").modal("show");
					}
...
<body>
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control myDate" readonly id="edit-startTime" value="2020-10-10">
							</div>
							<label for="edit-endTime" class="col-sm-2 control-label">结束日期</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control myDate" readonly id="edit-endTime" value="2020-10-20">
							</div>
						</div>
	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div id="query-div" class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <input class="form-control myDate" readonly type="text" id="queryStartDate" />
				    </div>
				  </div>
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">结束日期</div>
					  <input class="form-control myDate" readonly type="text" id="queryEndDate">
				    </div>
				  </div>
